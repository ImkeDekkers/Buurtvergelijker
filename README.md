...
The preprocessed data cannot be uploaded on GitHub because of its size. Therefore, the original dataset need to be retrieved from the supplier. After downloading the data, the data prep(aration) files can be run to prepare the data for use in the dashboard. 
